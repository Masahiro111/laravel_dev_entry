                                            ...
                                            <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    <label for="item_amount"
                                                        class="block text-sm font-medium text-gray-700">金額</label>
                                                    <input type="text" name="item_amount" id="amount" autocomplete="10"
                                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-sm">
                                                </div>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    <label for="published"
                                                        class="block text-sm font-medium text-gray-700">公開日</label>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    <label for="item_img"
                                                        class="block text-sm font-medium text-gray-700">ファイルのアップロード</label>
